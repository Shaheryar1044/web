...
class ChallengeController extends Controller
{
	...
	public function duplicateChallange($id , Request $request){
		...
		$challenge = Challenge::where('id','=',$id)->create([
            ...
            'hints_en'                => $challenge->challenge_hints_en,
            'hints_fr'                => $challenge->challenge_hints_fr,
            'hint1'                => $challenge->first_hint,
            'hint1_en'                => $challenge->first_hint_en,
            'hint1_fr'                => $challenge->first_hint_fr,
            ...
            'hint1_text'           => $challenge->text_above_first_hint,
            'hint1_text_en'           => $challenge->text_above_first_hint_en,
            'hint1_text_fr'           => $challenge->text_above_first_hint_fr,
            'hint2_text'           => $challenge->text_above_2nd_hint,
            'hint2_text_en'           => $challenge->text_above_2nd_hint_en,
            'hint2_text_fr'           => $challenge->text_above_2nd_hint_fr,
            'hint3_text'           => $challenge->text_above_3rd_hint,
            'hint3_text_en'           => $challenge->text_above_3rd_hint_en,
            'hint3_text_fr'           => $challenge->text_above_3rd_hint_fr,
