                ...
                <div class="card-body">
                   @if (session('status'))
                    ...
                    <form method="post" action="{{route('updateAdventure',[$adventures->id])}}" >
						...
						<div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                          <input type="date"  value="{{$adventures->start_time?$string2[0]:''}}" placeholder="23" name="date" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div id="groupsInfo" @if($adventures->attendees == 1) style="display: none;" @endif>
                            <div class="form-group" >
                                <div class="row">
                                    <div class="col-sm-4">
                            ...
                            <div id="renderNameRows">
                                @foreach($adventures->groups as $g)
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" value="{{$g->name}}" name="groupNames[]" required class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                @endforeach 
