                        ...
                        <form method="post" action="{{route('storeAdventure')}}" >
                            ...
                            <div class="form-group">
							 ...
							 <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="name" placeholder="Enter Adventure Name" value="" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                          <input type="date"  placeholder="23" name="date" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="timediv">
                                          <input type="number" min="0" max="23" placeholder="23" name="hours" class="form-control timeinput"><span class="form-control" style="border: none;">:</span>
                                          <input type="number" min="0" max="59" placeholder="00" class="form-control timeinput" name="minutes"> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" onkeyup="renderRows()" placeholder="enter number (3 -15)" min="3" max="15" required="" name="challanges" id="eventChallenges">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="challenge_countdown" id="challenge_countdown"  >
                                            ...
                                            <option value="15" {{old('challenge_countdown')=='15'? 'selected': ''}}>15 minutes</option>
                            ...
                            <div id="groupsInfo" style="display: none;">
                                <div class="form-group" >
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number"name="groups_no" placeholder="Enter Number (min )"  min='1' id="groups_no" value="{{old('groups_no')}}" onkeyup="renderGropnameRows()"  class="form-control">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number"name="users_per_group" placeholder="Enter Number (min 1)"  min='1' id="users_per_group" value="{{old('users_per_group')}}"  class="form-control">
...
@section('js')
    <script>
        ...
        function renderGropnameRows(){

            $('#renderNameRows').html('');
            let numberofGroups = $('#groups_no').val();
            for (var i = 1; i <= numberofGroups; i++) {
                ...
                var rowHtml =
                    '<br><div class="row">' +
                    '<div class="col-sm-4">' +
                    '<label>'+ i + sign +' Group Name</label>' +
                    '</div>' +
                    '<div class="col-sm-8">' +
                    '<input type="text" name="groupNames[]" required class="form-control">' +
                    '</div>' +
                    '</div><br>';
                    $('#renderNameRows').append(rowHtml);
            }
        }
