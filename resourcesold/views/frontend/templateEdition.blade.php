                        ...
                        <div class="col-sm-12 text-to-hide" id="challenge-{{$loop->iteration}}" @if($loop->iteration > 1) style="display:none"; @endif >
                            ...
                            @if($challenge->challenge_type == 'picture')
                                ...
                                <div class="zoom-box" style="position:relative;width:50%;display:inline-block;margin-top:5px;">
                                    ...
                                    <!--<img class="classImage" src="https://source.unsplash.com/6TIpY5KqCYo/600x450" width="200" height="150" />-->

                                    <img class="classImage img-fluid" src="{{$challenge->files[0]->file_path}}" width="500" height="250" />
                            ...
                            <input type="hidden" id="challengeCode-{{$loop->iteration}}" value="{{$challenge->final_code}}">
