...
;						  @if($locale == 'de')
                        ...
                        @if($group)
                        <p class="customFinal" style="margin:auto; margin-top:20px;font-size:25px !important;"><a href="{{url('final-score/'.$code.'/'.$group)}}" style="color:#fff"><img src="{{asset('public/images/score.png')}}" height="150" width="150">  </a> </p>
                        @endif
                    </div>
                </div>
            </div>
