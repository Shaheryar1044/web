    ...
    <div class="container styleContainer">
       <section class="top-section">
        ...
        <div class="row customRowArea">
            ...
            <div class="customBorderBox">
                    ...
                    @foreach($adventure->groups as $group)
                        ...
                        <div class="row customRowAlign">
                            ...
                            <div class="col-md-6">
                                <button class="btnCustomChoose" style="margin-right: 6px;">{{$group->hintscount}} Hints</button>
            ...
            <div style="width: 200px; margin: auto; border: 1px solid #E74218;background: #e742186e;padding: 14px;">
                @php
                        $count = 0;
                        $winner = 0;
                    @endphp
